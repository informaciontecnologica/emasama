<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div  ng-app="Apo" ng-controller="AdminVentas" class="container "  style="margin-top: 10px;">
             ...
             <div class="form-row col-sm-12">
                    <div class=" form-group col-sm-5" >
                        ...
                        <input class="form-control col-sm-12"
                               ng-change="buscarcliente();" ng-model="cliente"
                               type="text" placeholder="Buscar cliente" ng-model="cliente" />
                    </div>
                        <div style="z-index:2 ;background-color:  #20c997" ng-repeat="x in Lclientes">
                           {{x.nombre }}
                        </div>
...
<!--        <div   class="container "  style="margin-top: 10px;">
            <div class="card card-heading col-sm-12 col-md-12 col-lg-12 " >
                ...
                <
                <section class="container col-sm-12 col-md-12 col-lg-12" style="margin-top: 2px;" >
                    ...
                    <div class=" col-sm-12 " style="background-color: #007fff">
                        ...
                        <div class="form-inline form-group" >
                            ...
                            <input class="form-control col-3" placeholder="Buscar Articulos" type="text" ng-model="cliente" />
                        ...
                        <div class="col-sm-12">
                            ...
                            <form   ng-submit="FacturarAticulos()">
                                <table class="table">
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td><div class="" >Importe Total <span>$ 123.2312 {{1224, 43}}</span> </div></td>
                                        </tr>
                                    </tfoot>
                                </table>
